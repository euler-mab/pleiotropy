function [] = subplot_within_dynamics_z_bar(ind, figWidth, figHeight, panelSize, axisSize, numColPanels, numRowPanels, z_bar_y, idx_25, num_traits, y_lim, x_lim, y_lab, x_lab, title, fig_label, y_tick, y_tick_label, x_tick, x_tick_label)
...
% Create the plot
for i = 1:num_traits
    pl = plot(z_bar_y(:, i), '-', 'Color', phenotype_colour{i}, 'LineWidth', 1.1);
    hold on
end
