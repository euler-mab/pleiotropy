function [] = subplot_between_dynamics_x(ind, figWidth, figHeight, panelSize, stretch, axisSize, numColPanels, numRowPanels, x_t, num_types, y_lim, x_lim, y_lab, x_lab, title, fig_label, y_tick, y_tick_label, x_tick, x_tick_label)
...
if size(x_t, 1) ~= 0
    ...
    % Create the plot
    for i = 1:num_types
        pl = plot(x_t(:, i), '-', 'Color', genotype_colour{i}, 'LineWidth', 1.1);
        hold on
    end
