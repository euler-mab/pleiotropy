function [] = subplot_within_dynamics_x(ind, figWidth, figHeight, panelSize, axisSize, numColPanels, numRowPanels, x_y, idx_25, num_types, y_lim, x_lim, y_lab, x_lab, title, fig_label, y_tick, y_tick_label, x_tick, x_tick_label)
...
% Create the plot
for i = 1:num_types
    pl = plot(x_y(:, i), '-', 'Color', genotype_colour{i}, 'LineWidth', 1.1);
    hold on
end
