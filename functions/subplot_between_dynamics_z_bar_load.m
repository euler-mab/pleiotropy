function [] = subplot_between_dynamics_z_bar_load(ind, figWidth, figHeight, panelSize, stretch, axisSize, numColPanels, numRowPanels, z_bar_mutation_load, num_traits, y_lim, x_lim, y_lab, x_lab, title, fig_label, y_tick, y_tick_label, x_tick, x_tick_label)
...
if size(z_bar_mutation_load, 1) ~= 0
    
    % Create the plot
    for i = 1:num_traits
        pl = plot(-z_bar_mutation_load(:, i), '-', 'Color', phenotype_colour{i}, 'LineWidth', 1.1);
        hold on
    end
