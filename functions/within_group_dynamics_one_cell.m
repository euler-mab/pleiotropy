function [n_output, fe_count_output, fe_b_output, fe_d_output] = within_group_dynamics_one_cell(verbose, cooperation_experiment, replicates, t_0, t_by, t_end, rho, K, s_c, phi, mu, nu, num_traits, num_types, Z)
